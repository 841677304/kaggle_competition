...
def plot_results(image,prediction,label, args):
...
if __name__ == '__main__':
    parser = get_parser()
    args = parser.parse_args('--image E:/研三/kaggle竞赛/crf/ConvCRF-master/data/2007_000346_0img.png --label E:/研三/kaggle竞赛/crf/ConvCRF-master/data/2007_000346_5labels.png'.split())
    ...
    prediction = do_crf_inference(image, args)
    # Plot output
    plot_results(image,  prediction, label, args)
